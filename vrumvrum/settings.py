"""
Django settings for vrumvrum project.
...
SECRET_KEY = 'django-insecure-pp1e0z62xd4ee+wrm$ze@$=pess5-9a*%$$h91i)anua2c=-gs'
...
WSGI_APPLICATION = 'vrumvrum.wsgi.application'
